"""
Training script for Lung Disease Prediction model.
...
from src.preprocessing.lung_preprocessing import clean_lung_dataframe, LUNG_FEATURE_ORDER
RAW_PATH = os.path.join(BASE_DIR, "datasets", "raw", "lung.csv")
CLEAN_PATH = os.path.join(BASE_DIR, "datasets", "processed", "lung_clean.csv")
MODEL_DIR = os.path.join(BASE_DIR, "models", "lung")
...
def train_lung_model():
    ...
    metadata = {
        ...
        "feature_names": LUNG_FEATURE_ORDER,
