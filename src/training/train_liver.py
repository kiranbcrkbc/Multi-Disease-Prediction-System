"""
Training script for Liver Disease Prediction model (ILPD).
...
from src.preprocessing.liver_preprocessing import clean_liver_dataframe, LIVER_FEATURE_ORDER
RAW_PATH = os.path.join(BASE_DIR, "datasets", "raw", "liver.csv")
CLEAN_PATH = os.path.join(BASE_DIR, "datasets", "processed", "liver_clean.csv")
...
def train_liver_model():
    ...
    metadata = {
        ...
        "feature_names": LIVER_FEATURE_ORDER,
